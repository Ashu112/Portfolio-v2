      ...
      <div className="section-container pt-6">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <motion.div
            ...
            className="text-muted-foreground absolute bottom-8 left-1/2 flex -translate-x-1/2 flex-col items-center gap-2"
          >
            <span className="text-sm">Scroll to explore</span>
            <motion.div className="border-muted-foreground/30 flex h-10 w-6 items-start justify-center rounded-full border-2 p-1.5">
              <motion.div
